...
from .views import EVNStaticView, EVNPingView, EVNOptionsView, EVNMonthlyDataView, EVNDailyDataView, EVNCurrentPeriodView, EVNSyncHistoryView, EVNDebugDataView, EVNResyncView, EVNResyncMonthsView
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if "api_registered" not in hass.data[DOMAIN]:
        ...
        hass.http.register_view(EVNResyncMonthsView(hass))
